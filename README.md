...
I'm a software developer who enjoys turning real-world problems into working code and keep things fun along the way.  
...
2. **[Server‑Client Based File System](https://github.com/LiavSeg/Server-Client-Based-FIle-System)**  
   A low‑level file system backup tool using a TCP‑based binary protocol.  
   Server written in C++, client in Python — with secure directory handling and custom packet structure.  
   ![C++](https://img.shields.io/badge/-C++-00599C?style=flat)  
   ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat)

3. **[E2EE Messaging App Backend](https://github.com/LiavSeg/E2EE-Messgaing-App-Backend)**  
   Python socket‑based backend for an end‑to‑end encrypted messaging platform.  
   Implements RSA‑2048 key exchange, AES‑256‑CBC payload encryption, SHA‑256 digital signatures, OTP verification and custom binary protocol over TCP.  
   ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat)  
   ![Security](https://img.shields.io/badge/-End_to_End_Encryption-gray?style=flat)  
   ![TCP](https://img.shields.io/badge/-TCP_Sockets-blue?style=flat)
